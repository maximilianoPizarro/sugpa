        ...
        <div class="row">
          ...
          <div class="collapse navbar-collapse" id="main-nav">
            <ul class="nav navbar-nav navbar-right">
		      ...
		      <li><a href="cargar">Volver a cargar</a></li>
...
<div class="container">
  <h2>Error en la carga:</h2> <br>
  <div class="panel-group">

    <div class="panel panel-primary">
      <div class="panel-heading">Realizar una accion</div>
      <div class="panel-body">
      <h2>No se pudo cargar, verifique los datos ingresados</h2>
		<form action="cargar">
				<div class="col-md-16 text-center">
				<p class="boton-margen-inferior">
				<input class="btn btn-primary btn-lg" type="submit" name="cargar" value="Volver a Cargar"/></p>	
				</div>  
		</form>		    
      </div>
      </div>
